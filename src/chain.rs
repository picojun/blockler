...
impl Chain {
    ...
    pub fn update_difficulty(&mut self, difficulty: u32, reward: f32) -> bool {
        self.difficulty = difficulty;
        true        
    }

    pub fn update_reward(&mut self, difficulty: u32, reward: f32) -> bool {
        self.reward = reward;
        true
    }
    ...
    fn get_merkle(curr_trans: Vec<Transaction>) -> String {
        ...
        if merkle.len() % 2 == 1 {
            let last = markle.last().cloned().unwrap();
            merkle.push(last);
        }
